...
userorders=(List)session.getAttribute("userorders12"); %>
	...
	<div class="bg-img">
		...
		<!-- //banner -->
			...
			<div class="map">
	<form action=Userorderdelet method="post">
<table border="1">
  <tr>
  <td>id</td>
    <td>买家用户名</td><td>买家电话</td><td>买家地址</td><td>订单状态</td><td>宠物id</td><td>宠物数量</td><td>操作</td>
      </tr>       
<tr>
  ...
  <td>${userorders.buyer_username }</td>
          <td>${userorders.buyer_num }</td>
           ...
           <button id="buy" class="button button3" name="buy" 
		        type="submit"  value="${userorders.id }">删除</button>
          <!--  <input type="submit" class="button button3" value="删除">  --> </td>                                      
 </c:forEach>
     </tr>
</table>	
</form>				
