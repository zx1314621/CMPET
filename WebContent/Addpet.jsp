...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body">
    ...
    <form class="layui-form" action=Addpet method="post">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" name="num" required  lay-verify="required" placeholder="请输入数量" autocomplete="off" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item">
  ...
  <div class="layui-form-item">
    <label class="layui-form-label">雌雄</label>
    <div class="layui-input-block">
      <input type="radio" name="sex" value="female" title="雌">
      <input type="radio" name="sex" value="male" title="雄" checked>
    </div>
  </div>
